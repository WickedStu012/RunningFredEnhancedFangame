public class SoundListMoreGames : SoundList
{
	private SoundProp[] sounds = new SoundProp[3]
	{
		new SoundProp(0, "Music-RF-6-Intro-MoreGames", 1, false, SndType.SND_MUSIC, 35),
		new SoundProp(1, "Music-RF-6-Loop-MoreGames", 1, true, SndType.SND_MUSIC, 35),
