...
public class CharSkin : MonoBehaviour
{
	...
	private void Update()
	{
		if (isBlinking)
		{
			...
			if (accumTime > 0.05f)
			{
				...
				if (CharHelper.GetProps().HasWings && wings != null && blinkObjs.Count > 0)
				{
					wings.SetVisibility(!blinkObjs[0].enabled);
				}
				if (CharHelper.GetProps().HasJetpack && jetpack != null && blinkObjs.Count > 0)
				{
	...
	public void Blink(float time)
	{
		...
		if (CharHelper.GetProps().HasWings && wings == null)
		{
		...
		if (CharHelper.GetProps().HasJetpack && jetpack == null)
		{
			GameObject gameObject2 = CharHelper.GetCharStateMachine().GetJetpack();
			if (gameObject2 != null)
			{
	...
	{
		CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.LEGS_OFF, 0);
		...
		Transform transformByName = CharHelper.GetTransformByName("leftLeg2");
		...
		Transform transformByName2 = CharHelper.GetTransformByName("rightLeg2");
		...
		Transform transformByName3 = CharHelper.GetTransformByName("torso1");
	...
	public void Dismember(string part)
	{
		...
		{
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.HEAD_OFF, 0);
			...
			if (transformByName != null)
			{
				...
				PlaceSpurrOn(CharHelper.GetTransformByName("torso1"), "bloodSpurrNeck");
			}
			CharHelper.GetCharStateMachine().SwitchTo(ActionCode.RAGDOLL);
		}
		else if (string.Compare(part, "leftLeg1") == 0)
		{
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.LEFT_LEG_OFF, 0);
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.LEFT_LEG, 10);
			goreDic["goreLeftLeg1"].SetActive(true);
			Transform transformByName2 = CharHelper.GetTransformByName("leftLeg1");
			if (transformByName2 != null)
			{
				CharacterJoint component2 = transformByName2.GetComponent<CharacterJoint>();
				if (component2 != null)
				...
				PlaceSpurrOn(CharHelper.GetTransformByName("torso2"), "bloodSpurrLeftLeg1");
			}
			CharHelper.GetCharStateMachine().SwitchTo(ActionCode.RAGDOLL);
			Transform transformByName3 = CharHelper.GetTransformByName("torso1");
			if (transformByName3 != null)
		...
		{
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.RIGHT_LEG_OFF, 0);
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.RIGHT_LEG, 10);
			goreDic["goreRightLeg1"].SetActive(true);
			Transform transformByName4 = CharHelper.GetTransformByName("rightLeg1");
			...
			CharHelper.GetCharStateMachine().SwitchTo(ActionCode.RAGDOLL);
			Transform transformByName5 = CharHelper.GetTransformByName("torso1");
			...
			PlaceSpurrOn(CharHelper.GetTransformByName("torso2"), "bloodSpurrRightLeg1");
		}
		else if (string.Compare(part, "torso1") == 0 || string.Compare(part, "torso2") == 0)
		{
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.HALF_BODY_OFF, 0);
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.TORSO, 10);
			goreDic["goreTorso"].SetActive(true);
			Transform transformByName6 = CharHelper.GetTransformByName("torso1");
			...
			CharHelper.GetCharStateMachine().SwitchTo(ActionCode.RAGDOLL);
			Transform transformByName7 = CharHelper.GetTransformByName("torso2");
		...
		{
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.LEFT_ARM_OFF, 0);
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.TORSO, 10);
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.LEFT_ARM, 10);
			goreDic["goreLeftArm1"].SetActive(true);
			Transform transformByName8 = CharHelper.GetTransformByName("leftArm1");
			...
			CharHelper.GetCharStateMachine().SwitchTo(ActionCode.RAGDOLL);
			Transform transformByName9 = CharHelper.GetTransformByName("torso1");
		...
		{
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.RIGHT_ARM_OFF, 0);
			goreDic["goreRightArm1"].SetActive(true);
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.TORSO, 10);
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.RIGHT_ARM, 10);
			Transform transformByName10 = CharHelper.GetTransformByName("rightArm1");
			...
			CharHelper.GetCharStateMachine().SwitchTo(ActionCode.RAGDOLL);
			Transform transformByName11 = CharHelper.GetTransformByName("torso1");
		...
		{
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.LEFT_LEG_2_OFF, 0);
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.LEFT_LEG, 10);
			goreDic["goreLeftLeg1"].SetActive(true);
			Transform transformByName12 = CharHelper.GetTransformByName("leftLeg2");
			...
			Transform transformByName13 = CharHelper.GetTransformByName("torso1");
			...
			CharHelper.GetCharStateMachine().SwitchTo(ActionCode.RAGDOLL);
			PlaceSpurrOn(CharHelper.GetTransformByName("torso2"), "bloodSpurrLeftLeg");
		}
		else if (string.Compare(part, "rightLeg2") == 0)
		{
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.RIGHT_LEG_2_OFF, 0);
			CharHelper.GetCharBloodSplat().SplatOn(BodyDamage.RIGHT_LEG, 10);
			goreDic["goreRightLeg1"].SetActive(true);
			Transform transformByName14 = CharHelper.GetTransformByName("rightLeg2");
			...
			CharHelper.GetCharStateMachine().SwitchTo(ActionCode.RAGDOLL);
			Transform transformByName15 = CharHelper.GetTransformByName("torso1");
			...
			PlaceSpurrOn(CharHelper.GetTransformByName("torso2"), "bloodSpurrRightLeg");
		}
	...
	public void Pierced(Vector3 piercePoint)
	{
		...
		if (ConfigParams.useGore)
		{
			...
			PlaceSpurrOn(CharHelper.GetTransformByName("torso1"), piercePoint, Quaternion.identity);
		}
