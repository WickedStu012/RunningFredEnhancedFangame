...
public class ActSafetySpring : IAction
{
	...
	public ActSafetySpring(GameObject player)
		: base(player)
	{
		stateName = ActionCode.SAFETY_SPRING;
	...
	public override void GetIn(params object[] list)
	{
		...
		GUI3DPopupManager.Instance.ShowPopup("ConsumingItemPopupSafetySpring", null, null, null, null, false, null);
		CharHelper.GetEffects().EnableBounceSpringParticles();
		sm.IsGoingUp = true;
	}
